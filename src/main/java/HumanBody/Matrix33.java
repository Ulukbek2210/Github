package HumanBody;// Matrix3.java
...
public class Matrix33 {
    ...
    public static Matrix33 createRotation(double angleRadians) {
        Matrix33 m = new Matrix33();
    ...
    public static Matrix33 createScaling(double sx, double sy) {
        Matrix33 m = new Matrix33();
        m.data[0][0] = sx;
        m.data[1][1] = sy;
        return m;
     ...
     * For 3x3 matrices, standard multiplication is generally more efficient
     * than Strassen's algorithm due to lower constant factors and overhead.
