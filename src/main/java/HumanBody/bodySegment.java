package HumanBody;// BodySegment.java
import AnimationProject.Matrix3;
...
public class bodySegment {
    ...
    public void updateWorldTransform() {
        ...
        Matrix3 translationToPivot = Matrix3.createTranslation(localPivot.getX(), localPivot.getY());
        ...
        Matrix3 localTransform = translationToPivot.multiply(localRotation);
