...
public class Matrix3 {
    ...
    public static Matrix3 createTranslation(double tx, double ty) {
    ...
    public static Matrix3 createRotation(double angleRadians) {
        Matrix3 m = new Matrix3();
    ...
    public static Matrix3 createScaling(double sx, double sy) {
        Matrix3 m = new Matrix3();
        m.data[0][0] = sx;
        m.data[1][1] = sy;
        return m;
