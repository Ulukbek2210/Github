package VectorAnimation;// AnimationPanel.java
import javax.swing.*;
import java.awt.*;
import java.util.Arrays;
import java.util.List;

class Ma extends JPanel implements Runnable {
    ...
    private static final double[][] WALK_CYCLE_ANGLES = {
            ...
            // Frame 7 (Left foot forward, Right foot back)
            ...
            // Frame 15 (Right foot forward, Left foot back - repeating)
            {-20, -5, 0, 15, 5, 0, 20, -5, -20, 5, 0},
            // Frame 16
    ...
    private void setupCharacter() {
        ...
        lowerArmL = new BodySegment("LowerArmL", lowerArmShape, new Point(), 35);
        lowerArmR = new BodySegment("LowerArmR", lowerArmShape, new Point(), 35);
    ...
    private void drawSegment(Graphics2D g2d, BodySegment segment) {
        ...
        // The segment's local vertices are (0,0) and (length,0)
        ...
        if (segment.parent != null) {
            ...
            // For the torso (root), draw its base pivot
    ...
    public void run() {
        ...
        while (true) {
            ...
            if (elapsedTime >= FRAME_TIME_MILLIS) {
                ...
                head.setAngle(angles[10]); // Head nod for a bit of realism
                ...
                double bobbing = 5 * Math.sin(frameCount * (2 * Math.PI / (WALK_CYCLE_LENGTH / 2))); // Bob up/down twice per cycle
